...
public class AccommodationService {
    ...
    public List<AccommodationDto.ListItemDto> getAccommodationList(List<String> areaGroup) {
        List<Accommodation> accommodations = accommodationRepository.findAllByAreaGroup(areaGroup);
        return toListItemDtos(accommodations);
    }

    public List<AccommodationDto.ListItemDto> searchAccommodationList(String keyword) {
        List<Accommodation> accommodations = accommodationRepository.findAllByKeyword(keyword);
        return toListItemDtos(accommodations);
    }
